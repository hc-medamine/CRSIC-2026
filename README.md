...
4. Bulk ops / clone / import-export UI — news list bulk on `main` (PR #36); **events + publications bulk in progress** [docs/prds/2026-08-22-cms-events-publications-bulk-actions.md](./docs/prds/2026-08-22-cms-events-publications-bulk-actions.md); clone / import-export / other types still deferred
