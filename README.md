...
1. CMS UI to reassign editor/reviewer/publisher — **Approved PRD** [docs/prds/2026-08-22-cms-reassign-authorship-ui.md](./docs/prds/2026-08-22-cms-reassign-authorship-ui.md) (implement this slice)
...
| Field            | Value                                                                                                                                                          |
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Last updated     | **2026-08-22** (Align authorship PRD Approved; `main` still `071abc9` + cutover `b1c022c`) |
