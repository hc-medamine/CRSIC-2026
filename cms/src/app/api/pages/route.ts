...
import { createPage, listPagesForUser, type CreatePageInput } from "@/lib/content/pages";
...
function serialize(item: Awaited<ReturnType<typeof listPagesForUser>>[number]) {
  return {
    ...item,
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const item = await createPage(user, body);
