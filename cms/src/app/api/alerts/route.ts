...
import { createAlert, listAlertsForUser, type AlertInput } from "@/lib/content/alerts";
...
function serialize(item: Awaited<ReturnType<typeof listAlertsForUser>>[number]) {
  return {
    ...item,
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const item = await createAlert(user, body);
