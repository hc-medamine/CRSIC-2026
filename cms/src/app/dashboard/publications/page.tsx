  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-4xl flex-col gap-6 px-6 py-12 font-sans">
      <header className="flex flex-wrap items-center justify-between gap-4 border-b border-zinc-200 pb-4">
        <div>
          <p className="text-sm uppercase tracking-wide text-zinc-500">CRSIC CMS · Step 6</p>
          <h1 className="text-2xl font-semibold text-zinc-900">Publications</h1>
          <p className="mt-1 text-sm text-zinc-600">
            Draft → review → publish to public publications.json (covers.length === pubs.length).
          </p>
        </div>
        <div className="flex gap-3 text-sm">
          <Link href="/dashboard/publications/new" className="rounded bg-zinc-900 px-3 py-1.5 text-white">
            New publication
          </Link>
