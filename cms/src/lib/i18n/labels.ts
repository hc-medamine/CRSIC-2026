...
export const LABELS: LabelMap = {
  ...
  featuredNews: { en: "Home featured playlist", ar: "القائمة المميزة للرئيسية" },
  ...
  sitePages: { en: "Site pages", ar: "صفحات الموقع" },
  sitePagesTitle: { en: "Edit About, org, contact, cooperation", ar: "تحرير من نحن والتنظيم والاتصال والتعاون" },
  sitePagesSectionAbout: { en: "About", ar: "من نحن" },
  sitePagesSectionOrg: { en: "Organisation labels", ar: "تسميات الهيكل" },
  sitePagesSectionContact: { en: "Contact", ar: "الاتصال" },
  sitePagesSectionCoop: { en: "Cooperation intro", ar: "مقدمة التعاون" },
  sitePagesArabic: { en: "Arabic", ar: "عربي" },
  sitePagesEnglish: { en: "English", ar: "إنجليزي" },
  sitePagesEmail: { en: "Email", ar: "البريد الإلكتروني" },
  sitePagesPhone: { en: "Phone", ar: "الهاتف" },
  sitePagesWebmailUrl: { en: "Webmail URL", ar: "رابط البريد المهني" },
  sitePagesWebmailText: { en: "Webmail label", ar: "نص البريد المهني" },
  sitePagesPreview: { en: "About preview (from this form)", ar: "معاينة من نحن (من هذا النموذج)" },
  sitePagesSaved: { en: "Site pages saved", ar: "تم حفظ صفحات الموقع" },
  sitePagesPublished: { en: "Site pages published", ar: "تم نشر صفحات الموقع" },
  sitePagesLastPublished: { en: "Last published", ar: "آخر نشر" },
  sitePagesNeverPublished: {
    en: "Not published yet — About, org, contact, and cooperation stay on locales until you publish.",
    ar: "لم يُنشر بعد — ستبقى صفحات من نحن والتنظيم والاتصال والتعاون على النصوص الاحتياطية حتى تنشروا.",
  },
  sitePagesMissingRow: {
    en: "Site pages record missing. Run database migrations.",
    ar: "سجل صفحات الموقع غير موجود. نفّذوا ترحيلات قاعدة البيانات.",
  },
  sitePagesPublishFailed: {
    en: "Publish failed — About left on locales",
    ar: "فشل النشر — بقيت صفحة من نحن على النصوص الاحتياطية",
  },
  featuredNewsTitle: { en: "Home featured playlist", ar: "القائمة المميزة للرئيسية" },
  featuredNewsPlaylist: { en: "Playlist", ar: "القائمة" },
  featuredNewsHelp: {
    en: "Choose up to 10 published news or events for the Home featured carousel. Order here is the public order.",
    ar: "اختاروا حتى 10 أخبار أو فعاليات منشورة لشريط الصفحة الرئيسية. الترتيب هنا هو ترتيب العرض.",
  },
  featuredNewsCount: { en: "{n} of {max} items", ar: "{n} من {max} عناصر" },
  featuredNewsEmpty: {
    en: "No items yet. Add published news or events below, or publish an empty list to use the newest illustrated mix (up to 10 with covers).",
    ar: "لا عناصر بعد. أضيفوا أخبارًا أو فعاليات منشورة أدناه، أو انشروا قائمة فارغة لاستخدام أحدث العناصر ذات الصور (حتى 10).",
  },
  featuredNewsAdd: { en: "Add published item", ar: "إضافة عنصر منشور" },
  featuredNewsAddBtn: { en: "Add", ar: "إضافة" },
  featuredNewsPickOne: { en: "Select news or event…", ar: "اختاروا خبرًا أو فعالية…" },
  ...
  featuredNewsFallbackBanner: {
    en: "Home is currently showing up to 10 newest news and events that have a cover image (no live playlist).",
    ar: "الصفحة الرئيسية تعرض حاليًا حتى 10 من أحدث الأخبار والفعاليات ذات صورة غلاف (لا قائمة منشورة).",
  },
  ...
  featuredNewsNeverPublished: {
    en: "Never published — Home uses the newest illustrated mix fallback (up to 10 with covers).",
    ar: "لم تُنشر بعد — الصفحة الرئيسية تستخدم أحدث العناصر ذات الصور (حتى 10).",
  },
  ...
  actionPurgeStale: { en: "Purge", ar: "تطهير" },
  actionCancel: { en: "Cancel", ar: "إلغاء" },
  recycleStaleBanner: {
    en: "{n} items are older than 90 days. Purge removes only those. Opening this page does not delete them.",
    ar: "{n} عناصر أقدم من 90 يومًا. التطهير يحذف تلك فقط. فتح الصفحة لا يحذفها.",
  },
  recycleStaleBadge: { en: "Older than 90 days", ar: "أقدم من 90 يومًا" },
  recyclePurgeTitle: { en: "Delete permanently?", ar: "حذف نهائي؟" },
  recycleEmptyTitle: { en: "Empty the recycle bin?", ar: "إفراغ سلة المحذوفات؟" },
  recycleStaleTitle: { en: "Purge items older than 90 days?", ar: "تطهير العناصر الأقدم من 90 يومًا؟" },
  recycleTypeToConfirm: { en: "Type {word} to confirm", ar: "اكتبوا {word} للتأكيد" },
  colType: { en: "Type", ar: "النوع" },
  colBinnedAt: { en: "Moved to bin", ar: "نُقل إلى السلة" },
  confirmPurgeItem: {
    en: 'Permanently delete "{title}"? This cannot be undone. Unused media files will also be removed.',
    ar: 'حذف «{title}» نهائيًا؟ لا يمكن التراجع. ستُحذف أيضًا الملفات غير المستخدمة.',
  },
  confirmEmptyBin: {
    en: "Permanently delete {n} items and unused media? This cannot be undone.",
    ar: "حذف {n} عناصر والملفات غير المستخدمة نهائيًا؟ لا يمكن التراجع عن هذا الإجراء.",
  },
  confirmPurgeStale: {
    en: "Permanently delete {n} items older than 90 days and unused media? This cannot be undone.",
    ar: "حذف {n} عناصر أقدم من 90 يومًا والملفات غير المستخدمة نهائيًا؟ لا يمكن التراجع.",
  },
  recycleConfirmWord: { en: "DELETE", ar: "حذف" },
  recycleConfirmMismatch: {
    en: "Confirmation word did not match. Nothing was deleted.",
    ar: "كلمة التأكيد غير مطابقة. لم يُحذف شيء.",
  },
  restoredShort: { en: "Restored as a draft.", ar: "استُعيد كمسودة." },
  purgedShort: { en: "Permanently deleted.", ar: "حُذف نهائيًا." },
  pageDescAudit: {
  ...
  auditVerbRecycle: { en: "Moved to recycle bin", ar: "نقل إلى سلة المحذوفات" },
  auditVerbClone: { en: "Duplicated", ar: "نسخ" },
  auditVerbCloneUndo: { en: "Clone cancelled", ar: "إلغاء النسخ" },
  auditVerbRestore: { en: "Restored", ar: "استعادة" },
  ...
  recycledShort: { en: "Moved to recycle bin.", ar: "نُقل إلى سلة المحذوفات." },
  actionFailed: {
  ...
  actionRecycle: { en: "Move to recycle bin", ar: "نقل إلى سلة المحذوفات" },
  actionDuplicate: { en: "Duplicate", ar: "نسخ" },
  cloneConfirmTitle: { en: "Duplicate this item?", ar: "نسخ هذا العنصر؟" },
  cloneConfirmBody: {
    en: "A new draft will be created with empty media. The original stays unchanged.",
    ar: "ستُنشأ مسودة جديدة بلا وسائط. يبقى الأصل دون تغيير.",
  },
  cloneResultTitle: { en: "Draft copy created", ar: "أُنشئت نسخة مسودة" },
  cloneResultBody: {
    en: "Stay here, open the new draft, or cancel the clone to delete it.",
    ar: "ابقوا هنا، أو افتحوا المسودة الجديدة، أو ألغوا النسخ لحذفها.",
  },
  cloneOpenDraft: { en: "Open draft", ar: "فتح المسودة" },
  cloneCancelClone: { en: "Cancel clone", ar: "إلغاء النسخ" },
  cloneClose: { en: "Close", ar: "إغلاق" },
  cloneUndone: { en: "Clone cancelled.", ar: "أُلغي النسخ." },
  bulkConfirmCloneTitle: { en: "Duplicate these items?", ar: "نسخ هذه العناصر؟" },
  bulkConfirmClone: {
    en: "Create {n} new drafts with empty media?",
    ar: "إنشاء {n} مسودات جديدة بلا وسائط؟",
  },
  bulkReportClone: {
    en: "Duplicated {done}. Skipped {skipped}.",
    ar: "نُسخ {done}. تُرك {skipped}.",
  },
  bulkSkipNoCreate: {
    en: "You cannot create this type",
    ar: "لا يمكنكم إنشاء هذا النوع",
  },
  bulkSkipWrongType: { en: "Wrong content type", ar: "نوع محتوى غير مطابق" },
  colActions: { en: "Actions", ar: "إجراءات" },
  actionDelete: { en: "Delete permanently", ar: "حذف نهائي" },
  confirmRecycle: {
    en: "Move this item to the recycle bin? You can restore it later as a draft.",
    ar: "نقل هذا العنصر إلى سلة المحذوفات؟ يمكن استعادته لاحقًا كمسودة.",
  },
  confirmDelete: {
  ...
  loadMoreLoading: { en: "Loading…", ar: "جارٍ التحميل…" },
  loadMoreError: { en: "Could not load more items. Try again.", ar: "تعذّر تحميل المزيد. حاولوا مرة أخرى." },
  bulkSelectRow: { en: "Select", ar: "تحديد" },
  bulkSelectLoaded: { en: "Select all loaded rows", ar: "تحديد كل الصفوف المحمّلة" },
  bulkSelected: { en: "{n} selected", ar: "{n} محدد" },
  bulkClear: { en: "Clear", ar: "مسح" },
  bulkConfirmUnpublishTitle: { en: "Unpublish these news items?", ar: "إلغاء نشر هذه الأخبار؟" },
  bulkConfirmUnpublish: {
  ...
  bulkConfirmRecycle: {
    ...
    ar: "نقل {n} عناصر إلى سلة المحذوفات؟",
  },
  bulkConfirmRecyclePublished: {
    en: "{n} of them are published and will be unpublished first, then moved to the bin.",
    ar: "{n} منها منشورة وستُلغى نشرها أولاً ثم تُنقل إلى السلة.",
  },
  bulkReportTitle: { en: "Bulk action finished", ar: "انتهى الإجراء الجماعي" },
  bulkReportUnpublish: {
    en: "Unpublished {done}. Skipped {skipped}.",
    ar: "أُلغي نشر {done}. تُرك {skipped}.",
  },
  bulkReportRecycle: {
    en: "Moved {done} to the recycle bin. Skipped {skipped}.",
    ar: "نُقل {done} إلى سلة المحذوفات. تُرك {skipped}.",
  },
  bulkDismiss: { en: "Dismiss", ar: "إغلاق" },
  bulkSkippedHeading: { en: "Skipped", ar: "متروك" },
  bulkSkipNotFound: { en: "Not found", ar: "غير موجود" },
  bulkSkipFourEyes: {
    en: "You cannot unpublish a story you authored.",
    ar: "لا يمكن إلغاء نشر خبر ألّفتموه بأنفسكم.",
  },
  bulkSkipNotPublished: { en: "Not published", ar: "غير منشور" },
  bulkSkipAway: {
    en: "Review actions are frozen while you are Away.",
    ar: "إجراءات المراجعة مجمّدة أثناء الغياب.",
  },
  ...
  bulkSkipOther: { en: "Could not complete this item", ar: "تعذّر إتمام هذا العنصر" },
  ...
  fieldEventSection: { en: "Section *", ar: "القسم *" },
  fieldEventCategory: { en: "Category *", ar: "التصنيف *" },
  fieldSectionActivities: { en: "Activities", ar: "الفعاليات" },
  fieldSectionMeetings: { en: "Conferences", ar: "الملتقيات" },
  fieldCategoryLecture: { en: "Scientific lectures", ar: "محاضرات علمية" },
  fieldCategoryVisit: { en: "Scientific visits", ar: "زيارات علمية" },
  fieldCategoryTraining: { en: "Training courses", ar: "دورات تكوينية" },
  fieldCategoryStudyDay: { en: "Study days", ar: "أيام دراسية" },
  fieldCategoryIntl: { en: "International conferences", ar: "ملتقيات دولية" },
  fieldCategoryNat: { en: "National conferences", ar: "ملتقيات وطنية" },
  fieldCategoryCultural: { en: "Cultural conferences", ar: "ملتقيات ثقافية" },
...
const AUDIT_VERB_KEYS: Record<string, string> = {
  ...
  recycle: "auditVerbRecycle",
  clone: "auditVerbClone",
  clone_undo: "auditVerbCloneUndo",
  restore: "auditVerbRestore",
