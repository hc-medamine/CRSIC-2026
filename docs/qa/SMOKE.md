...
| A4b | Home news fades to the next page as soon as the section is on screen, then ~5s; pause on cards only; last page cards keep normal height | ☐ |
...
| E4 | Root README / `docs/WORKLOG.md` updated if structure or process changed | ☐ |
