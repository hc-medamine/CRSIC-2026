...
| [2026-08-20-cms-desk-interiors.md](./2026-08-20-cms-desk-interiors.md) | **Approved** — I1 **Delivered** on `main` (PR #31); I2 implemented, awaiting walkthrough | I1 lists + login bubbles; I2 forms/admin/login |
...
| [2026-08-22-cms-clone-import-export.md](./2026-08-22-cms-clone-import-export.md) | **Draft** (2026-08-22) | Cut 1: clone to new draft (empty media, all types). Later: JSON import/export as drafts. **Do not implement until Approved.** |
| [2026-08-23-cms-editor-recycle.md](./2026-08-23-cms-editor-recycle.md) | **Approved** (2026-08-23) | Editors recycle own draft/rejected; scoped bin + restore. SA keeps unpublished recycle and purge. |
