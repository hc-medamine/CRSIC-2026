...
See commit history / [WORKLOG.md](../WORKLOG.md). P0–P1 responsive/motion items closed.
...
On ≤768px, `#home-pub-grid` uses CSS scroll-snap (≈82% card + peek). Desktop/tablet grid unchanged. Documented in [README.md](../../README.md) §6.3 and [WORKLOG.md](../WORKLOG.md).
